...
//matt = this is a function and it is the mad lib. This mad lib is about a restraunt
...
menu() //madlibs code this is a function = matt
}
...
menu() //Matts code, this is a func and it is the mad lib. It is about making pizza
...
func worldDomination(){
    ...
    print("You are \(b) a evil villian. You are a villian becuase \(m) this must be accomplished. Your evil idea is \(i) this is your plant victory. Your evil base is in \(l) it has great defences and no one will expect it. Your evil nemeisis is \(n) he must be destroyed to dominate the world. Your ultimate weapon is \(s) this will cripple anyone who stands in your way. Your first target for world domination is \(y) this place will need to be in a good location. Your evil costume is \(c) This will be very intimidating. Your backup plan is \(p) This is needed in case you will not dominate the Earth. Your retirement plan is to \(r) This is after you have dominated the world. Congratulations Villian you are ready for world domination go out there and beat \(n). This is a product of Juan coporation. Copyright 2016 all rights reserved ")
menu()
...
menu() //Tiger, this is a func. It is about Taken Liam Neeson